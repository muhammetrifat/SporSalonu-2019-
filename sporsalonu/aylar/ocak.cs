...
{
    public partial class ocak : Form
    {
        public ocak()
        {
        ...
        private void ocak_Load(object sender, EventArgs e)
        {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            string tar = simdi.ToString("1.01.2019");
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("2.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("3.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("4.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("5.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("6.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("7.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("8.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("9.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("10.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("11.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("12.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("13.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("14.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("15.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("16.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("17.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("18.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("19.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("20.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("21.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("22.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("23.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("24.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("25.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("26.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("27.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("28.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("29.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("30.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
        ...
        {
            DateTime simdi = new DateTime();
            string tar = simdi.ToString("31.01.2019");
            DataSet dts = new DataSet();
            DataTable dt = new DataTable();
            OleDbDataAdapter addtr = new OleDbDataAdapter("Select * from " + giris.tckno + " where tarih like '%" + tar + "%'", baglanti);
            addtr.Fill(dt);
